...
#> Chain 1:                4.378 seconds (Sampling)
#> Chain 1:                10.341 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 2:                4.376 seconds (Sampling)
#> Chain 2:                10.089 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 5.902 seconds (Warm-up)
#> Chain 3:                4.049 seconds (Sampling)
#> Chain 3:                9.951 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 6.012 seconds (Warm-up)
#> Chain 4:                4.27 seconds (Sampling)
