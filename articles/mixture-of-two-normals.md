...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 4.747 seconds (Warm-up)
#> Chain 1:                3.537 seconds (Sampling)
#> Chain 1:                8.284 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 2:                3.371 seconds (Sampling)
#> Chain 2:                7.772 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 4.868 seconds (Warm-up)
#> Chain 3:                3.314 seconds (Sampling)
#> Chain 3:                8.182 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 4.662 seconds (Warm-up)
#> Chain 4:                3.188 seconds (Sampling)
#> Chain 4:                7.85 seconds (Total)
#> Chain 4:
```
