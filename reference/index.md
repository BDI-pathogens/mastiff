...
- [`distribution.beta()`](https://bdi-pathogens.github.io/mastiff/reference/distribution.beta.md)
  : distribution.beta
- [`distribution.beta_binomial()`](https://bdi-pathogens.github.io/mastiff/reference/distribution.beta_binomial.md)
...
- [`distribution.discrete.beta_binomial.class`](https://bdi-pathogens.github.io/mastiff/reference/distribution.discrete.beta_binomial.class.md)
  :
...
- [`distribution.multivariate.copula.class`](https://bdi-pathogens.github.io/mastiff/reference/distribution.multivariate.copula.class.md)
  :
